...
class KocurDOS:
    VERSION = "1.0.0"
    GITHUB_REPO = "https://api.github.com/repos/user/kocur-dos"  # Zmień na swoje repo
...
Dostępne komendy:
  ...
  exit          - Wyjście
    ...
    def create_folder(self):
        name = tk.simpledialog.askstring("Nowy folder", "Nazwa folderu:")
        if name:
            try:
    ...
    def check_for_updates(self):
        def check_updates_thread():
            try:
                # Sprawdź wersję na GitHub (przykładowy URL)
    ...
    def download_update(self, version):
        try:
            # Pobierz updater
            updater_url = f"https://github.com/user/kocur-dos/releases/download/v{version}/updater.py"
